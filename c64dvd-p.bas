...
sub MEMORY_T.poke8(byval adr as ulongint,byval v as ulongint)
  ...
  select case adr
    ...
    case sys_offset+42 ' closes device
     print #1, "// End of file"
     close #1
    case sys_offset+43 ' Graphics Processing Unit - 1
	 select case v
		case 0: print #1, "a";
    ...
    case sys_offset+44 ' Graphics Processing Unit - 2
     select case v
    ...
    case sys_offset+45 ' Numeric Processing Unit
     select case v 
      case 0:
    ...
    case sys_offset+46 ' Render                    
	  ...
	  bload "vram/"+str(mem64(sys_offset+47))+".bmp",image
	  put(0,0), image, alpha	       
    ...
    case sys_offset+49 ' Anamation player
      ...
      next frame
    case sys_offset+52 ' sets system_offset
      sys_offset = mem64(sys_offset+53) shl 16 + mem64(sys_offset+54) shl 08 +_
		           mem64(sys_offset+55)
    case sys_offset+56 ' resets screen  	    
	 cls : bload "background.bmp",0
     for offset = 0 to 1024: poke8(1024+offset, 32): next offset
    case sys_offset+57  'Graph Functions
     select case v
         case 0 ' Open R device
          open "tmp.r" for output as #1
          print #1, "setwd(" + chr(34) + "." + chr(34) + ")"
          print #1, "bmp(filename=" + chr(34) + _
          str(mem64(sys_offset+47))+".bmp" + chr(34) + _
    ...
    case sys_offset+59 'Graph Sub functions
    case sys_offset+60 'Graph Render
         shell "Rscript tmp.r"
    	 shell "mv "+str(mem64(sys_offset+47))+".bmp vram/"+ _
    	 str(mem64(sys_offset+47))+".bmp"
	     poke8(sys_offset+40,0) ' clear screen
	     bload "vram/"+str(mem64(sys_offset+47))+".bmp",image
	     put(0,0), image, alpha	       
  	     shell "rm tmp.r 0.bmp"
    case sys_offset+61 'Graph Libraries
     select case v 
      case 0
       print #1, "library(ggplot2)"
     end select
    case sys_offset+62 'Graph Packages 
     select case v
      case 0
       print #1, "require(lattice)"
     end select 
    case sys_offset+63 ' ASCII Table
      Draw String (mem64(sys_offset+63)*8,mem64(sys_offset+64)*8),chr(v) 
    case sys_offset+64 ' ASCII Table
      msg=chr(v): print #1, msg;: msg=""
    case sys_offset+65 ' ASCII Table
      msg=chr(v): print #1, msg: msg=""
    case sys_offset+66
