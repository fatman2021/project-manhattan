...
inp = (
    bpy.data.materials["Emission.001"]
    .node_tree.nodes["Material Output"]
    .inputs["Surface"]
)
outp = (
    bpy.data.materials["Emission.001"].node_tree.nodes["Emission"].outputs["Emission"]
)
...
bpy.data.materials["Emission.001"].node_tree.nodes["Emission"].inputs[
    "Strength"
...
bpy.data.materials["Glossy"].node_tree.nodes["Glossy BSDF"].inputs[
    "Roughness"
].default_value = 0.05
bpy.data.materials["Glossy"].node_tree.nodes["Glossy BSDF"].inputs[
    "Color"
].default_value = (0.26, 0.30, 0.8, 1.0)
