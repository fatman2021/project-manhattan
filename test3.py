...
bpy.data.lamps["Lamp"].node_tree.nodes["Emission"].inputs["Color"].default_value = (
    1.0,
    0.80,
    0.50,
    1.0,
...
bpy.data.materials["Glass"].node_tree.nodes["Glass BSDF"].inputs[
    "Color"
].default_value = (1.0, 0.80, 0.50, 1.0)
bpy.ops.mesh.primitive_monkey_add()
...
bpy.data.materials["Deffuse"].node_tree.nodes["Diffuse BSDF"].inputs[
    "Color"
].default_value = (1.0, 0.80, 0.50, 1.0)
