...
L13:
  '          $47D(1149)                                                 $47E(1150)
  mov(kernal(xwords(&B000010001111101)), bytes(&B00101010)): mov(kernal(xwords(&B000010001111110)), bytes(&B00100000))
  '          $47F(1151)
...
L20: 
  mov(kernal(&H48F), bytes(&B00100000)): mov(kernal(&H490), bytes(&B10000110))
