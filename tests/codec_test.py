...
class TestC64Codecs(unittest.TestCase):
    def test_lowercase(self):
        ...
        self.assertEqual(
            b"HELLO \xd7\xcf\xd2\xcc\xc4 123 @!\x5c",
    ...
    def test_screencodes_lowercase(self):
        ...
        self.assertEqual(
            b"\x08\x05\x0c\x0c\x0f\x20\x57\x4f\x52\x4c\x44\x20\x31\x32\x33\x20\x00\x21\x1c",
            "hello WORLD 123 @!£".encode(codec),
        )
    ...
    def test_screencodes_uppercase(self):
        ...
        self.assertEqual(
            b"\x17\x0f\x12\x0c\x04\x20\x31\x32\x33\x20\x00\x21\x1c",
            "WORLD 123 @!£".encode(codec),
        )
