...
case sys_offset+&HAC ' opens video device
 ...
 print #1, "bpy.context.scene.cycles.use_progressive_refine = True"
 ...
 print #1, "bpy.context.scene.cycles.transmission_bounces = 1"
 ...
 print #1, "bpy.data.objects['Cube'].select_set(True)"
 print #1, "bpy.context.view_layer.objects.active = bpy.data.objects['Cube']"
 print #1, "scene = bpy.data.scenes["+chr(34)+"Scene"+chr(34)+"]"
