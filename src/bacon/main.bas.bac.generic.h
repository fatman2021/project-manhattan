...
extern struct timeval __b2c__tm;
extern time_t __b2c__elapsed_secs;
extern int __b2c__elapsed_usecs;
...
extern char **__b2c__deltree;
extern int __b2c__del_ctr;
extern char *__b2c__assign;
extern char *__b2c__split;
extern char *__b2c__split_tmp;
extern FILE *__b2c__inFile;
extern FILE *__b2c__outFile;
extern size_t __b2c__Byte;
extern struct dirent *__b2c__dir;
extern struct termios __b2c__tty;
extern struct timeval __b2c__to;
extern struct hostent *__b2c__he;
extern char *__b2c__host;
extern char *__b2c__port;
extern struct sockaddr_in *__b2c__addr, *__b2c__from;
extern struct ip_mreq __b2c__imreq;
extern int __b2c__yes;
extern char __b2c__ttl;
extern int __b2c__result;
extern int __b2c__handle;
extern char __b2c__data_client[512];
extern char __b2c__data_server[512];
extern int __b2c__counter;
extern int __b2c__is_escaped, __b2c__in_string;
extern int __b2c__arglen;
extern char **__b2c__stringstack;
extern double *__b2c__doublestack;
extern long *__b2c__longstack;
extern int *__b2c__typestack;
extern int __b2c__stackptr;
...
#define __b2c__INRANGE(x)                                                      \
  ((unsigned long)x > __b2c__ptrlow && (unsigned long)x < __b2c__ptrhgh ? 1 : 0)
#define __b2c__SETRANGE(x)                                                     \
  if ((unsigned long)x < __b2c__ptrlow)                                        \
    __b2c__ptrlow = (unsigned long)x - 1;                                      \
  if ((unsigned long)x > __b2c__ptrhgh)                                        \
    __b2c__ptrhgh = (unsigned long)x + __b2c__BUFOFFSET + 1;
...
#define RUNTIMEERROR(a, x, y, z)                                               \
  do {                                                                         \
    fprintf(stderr, "Runtime error: statement '%s' at line %d in '%s': %s\n",  \
            a, x, y, ERR__b2c__string_var(z));                                 \
    exit(z);                                                                   \
  } while (0)
#define RUNTIMEFERR(a, x, y, z)                                                \
  do {                                                                         \
    fprintf(stderr, "Runtime error: function '%s' at line %d in '%s': %s\n",   \
            a, z, y, ERR__b2c__string_var(x));                                 \
    exit(x);                                                                   \
  } while (0)
/* BaCon functions */
...
#define ALIGN__b2c__string_var(...)                                            \
  __b2c__align(__b2c_lineno, __b2c_filename, __VA_ARGS__, 0)
...
#define BASENAME__b2c__string_var(...)                                         \
  __b2c__dirname(__b2c_lineno, __b2c_filename, 1, __VA_ARGS__, 0)
...
#define BYTELEN(x, ...)                                                        \
  __b2c__blen(__b2c_lineno, __b2c_filename, "BYTELEN", x, __VA_ARGS__, 0)
...
#define COUNT(x, y)                                                            \
  ((x) != NULL ? __b2c__count(__b2c_lineno, __b2c_filename, x, y) : 0)
...
#define DIRNAME__b2c__string_var(...)                                          \
  __b2c__dirname(__b2c_lineno, __b2c_filename, 2, __VA_ARGS__, 0)
...
#define EXEC__b2c__string_var(...)                                             \
  __b2c__exec(0, __b2c_lineno, __b2c_filename, __VA_ARGS__, 0, 0)
#define EXP(x) exp((double)x)
#define EXPLODE__b2c__string_var(...)                                          \
  __b2c__explode(__b2c_lineno, __b2c_filename, __VA_ARGS__, NULL)
#define EXTRACT__b2c__string_var(x, ...)                                       \
  __b2c__extract(__b2c_lineno, __b2c_filename, x, __VA_ARGS__, -1)
#define FALSE 0
...
#define FILL__b2c__string_var(x, y)                                            \
  ((y) >= 0 && (y) <= 0x10FFFF ? __b2c__fill(x, y) : "")
...
#define FP(x) (void *)(&x)
#define GE >=
#define GETENVIRON__b2c__string_var(x)                                         \
  ((x) != NULL ? __b2c__getenv(x) : (char *)"null")
#define GETKEY __b2c__getch()
#define GETPEER__b2c__string_var(x)                                            \
  __b2c__getpeer(__b2c_lineno, __b2c_filename, x)
...
#define INSERT__b2c__string_var(x, y, z)                                       \
  __b2c__insert(__b2c_lineno, __b2c_filename, x, y, z)
#define INSTR(...) __b2c__instr(__b2c_lineno, __b2c_filename, __VA_ARGS__, -1)
#define INSTRREV(...)                                                          \
  __b2c__instrrev(__b2c_lineno, __b2c_filename, __VA_ARGS__, -1)
#define INT(x) lrint((double)x)
#define IS ==
#define ISASCII(x) __b2c__isascii(x)
#define ISFALSE(x) ((x) == 0)
#define ISKEY(x, ...)                                                          \
  ((__b2c_INDIRECT(__b2c__##x##__add_secure_, __b2c_assoc_##x)(0, __VA_ARGS__, \
                                                               NULL) == NULL)  \
       ? 0                                                                     \
       : 1)
#define ISNOT !=
...
#define LE <=
#define LEFT__b2c__string_var(x, y)                                            \
  __b2c__left(__b2c_lineno, __b2c_filename, x, y)
#define LEN(x)                                                                 \
  (__b2c__option_utf8                                                          \
       ? __b2c__ulen(__b2c_lineno, __b2c_filename, "LEN", x, -1)               \
       : __b2c__len(x))
#define ULEN(...)                                                              \
  __b2c__ulen(__b2c_lineno, __b2c_filename, "ULEN", __VA_ARGS__, -1)
...
#define MID__b2c__string_var(x, ...)                                           \
  __b2c__mid(__b2c_lineno, __b2c_filename, x, __VA_ARGS__, -1)
...
#define NRKEYS(x)                                                              \
  __b2c__hashtable_count(__b2c_INDIRECT(&__b2c__##x##_table_, __b2c_assoc_##x))
#define NUMBER long
#define OBTAIN__b2c__string_var(x, ...)                                        \
  __b2c_INDIRECT(__b2c__##x##_obtain_, __b2c_assoc_##x)(0, __VA_ARGS__, NULL)
...
#define PEEK(x)                                                                \
  (__b2c__peek_check(__b2c_lineno, __b2c_filename, (char *)x,                  \
                     sizeof(__b2c__MEMTYPE)) == 0                              \
       ? *(__b2c__MEMTYPE *)(x)                                                \
       : 0)
#define PI 3.14159265358979323846
#define POW(x, y) pow((double)x, (double)y)
#define PROPER__b2c__string_var(...)                                           \
  __b2c__proper(__b2c_lineno, __b2c_filename, __VA_ARGS__, NULL)
#define RAD(x) (x * PI / 180)
#define RANDOM(x) ((x) != 0 ? random() / (MAXRANDOM / (x)) : 0)
#define REALPATH__b2c__string_var(...)                                         \
  __b2c__dirname(__b2c_lineno, __b2c_filename, 0, __VA_ARGS__, 0)
#define REAP(x) waitpid(x, NULL, WNOHANG)
#define REGEX(x, y) __b2c__regex(__b2c_lineno, __b2c_filename, x, y)
#define REPLACE__b2c__string_var(x, ...)                                       \
  __b2c__replace(__b2c_lineno, __b2c_filename, x, __VA_ARGS__, -1)
#define REV__b2c__string_var(...) __b2c__rev(__VA_ARGS__, NULL)
#define REVERSE__b2c__string_var(x)                                            \
  __b2c__reverse(__b2c_lineno, __b2c_filename, x)
#define RIGHT__b2c__string_var(x, y)                                           \
  __b2c__right(__b2c_lineno, __b2c_filename, x, y)
#define RND random()
...
#define RUN__b2c__string_var(...)                                              \
  __b2c__exec(1, __b2c_lineno, __b2c_filename, __VA_ARGS__, 0, 0)
#define SEARCH(...) __b2c__search(__b2c_lineno, __b2c_filename, __VA_ARGS__, -1)
#define SECOND(x) __b2c__time(x, 6)
#define SETENVIRON(x, y)                                                       \
  if ((x) != NULL && (y) != NULL)                                              \
  setenv(x, y, 1)
...
#endif
struct __b2c__hashtable_internal_slot_t {
  HASHTABLE_U32 key_hash;
  int item_index;
  int base_count;
};
typedef struct __b2c__hashtable_t {
  void *memctx;
  int count;
  int item_size;
  struct __b2c__hashtable_internal_slot_t *slots;
  int slot_capacity;
...
void __b2c__hashtable_init(__b2c__hashtable_t *table, int item_size,
                           int initial_capacity, void *memctx);
void __b2c__hashtable_term(__b2c__hashtable_t *table);
void *__b2c__hashtable_insert(__b2c__hashtable_t *table, HASHTABLE_U64 key,
                              void const *item);
