	...
	*(uint8*)((uint8*)RAM$ + (int64)ADR$1) = (uint8)V$1;
	{
		...
		label$447:;
		{
			R1$ = (uint32)fb_D2L( ((double)(FOV$ * (int64)X_AXIS0$) / (double)((int64)Z_AXIS0$ + Z_CENTER$)) + (double)X_CENTER$ );
		}
		goto label$199;
		label$446:;
		...
		label$449:;
		{
			R2$ = (uint32)fb_D2L( ((double)(FOV$ * (int64)Y_AXIS0$) / (double)((int64)Z_AXIS0$ + Z_CENTER$)) + (double)Y_CENTER$ );
		}
		goto label$199;
		label$448:;
		...
		label$463:;
		{
			PX1$ = fb_F2L( *(float*)((uint8*)POINTS$ + (fb_F2L( *(float*)((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) ) * 24ll)) );
			PX2$ = fb_F2L( *(float*)((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 4ll) ) * 24ll)) );
			PX3$ = fb_F2L( *(float*)((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 8ll) ) * 24ll)) );
			PY1$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) ) * 24ll)) + 4ll) );
			PY2$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 4ll) ) * 24ll)) + 4ll) );
			PY3$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 8ll) ) * 24ll)) + 4ll) );
			PZ1$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) ) * 24ll)) + 8ll) );
			PZ2$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 4ll) ) * 24ll)) + 8ll) );
			PZ3$ = fb_F2L( *(float*)(((uint8*)POINTS$ + (fb_F2L( *(float*)(((uint8*)TRIS$ + (TRI_NUM$ * 12ll)) + 8ll) ) * 24ll)) + 8ll) );
		}
		goto label$199;
		label$462:;
