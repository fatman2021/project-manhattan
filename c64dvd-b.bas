...
sub MEMORY_T.poke64(byval adr as ulongint,byval v as ulongint)
 ...
 /'     case 10 'Ootput type
	      ...
	      select case mem64(sys_offset+200)
	       ...
	       case else
	        print #1, "bpy.data.materials['"+material+str(mem64(sys_offset+203))+_
	                   "'].node_tree.nodes.new(type="+chr(34)+shader+chr(34)+")"
	        print #1, "inp = bpy.data.materials['"+material+_
	                  str(mem64(sys_offset+203))+"'].node_tree.nodes["+chr(34)+_
	                  "Material Output"+chr(34)+"].inputs["+_
	                  chr(34)+ninput+chr(34)+"]"
	        print #1, "outp = bpy.data.materials['"+material+_
	                  str(mem64(sys_offset+203))+"'].node_tree.nodes["+chr(34)+node+_
	                  chr(34)+"].outputs["+chr(34)+noutput+chr(34)+"]"	                  		                   	         	         
	      end select	            
	   case 17 'Active material input
	     select case mem64(sys_offset+200)     
	            case 0 'Sets input 0
					 print #1, "'].node_tree.nodes["+chr(34)+node+_
							   chr(34)+"].inputs["+chr(34)+ninput+_
							   chr(34)+"].default_value = ("+str(mem64(sys_offset+203))+_
							   "."+str(mem64(sys_offset+206))+","+str(mem64(sys_offset+204))+"."+_
							   str(mem64(sys_offset+207))+","+str(mem64(sys_offset+205))+_
							   "."+str(mem64(sys_offset+208))+","+str(mem64(sys_offset+209))+"."+_
							   str(mem64(sys_offset+210))+")"
			    case 1 'Sets input 1 and/or input 2
					 print #1, "'].node_tree.nodes["+chr(34)+node+_
							   chr(34)+"].inputs["+chr(34)+ninput+_
							   chr(34)+"].default_value = "+str(mem64(sys_offset+203))+_
							   "."+str(mem64(sys_offset+206))		
 
	      end select                
       case 18 'Link and set active material
	      select case mem64(sys_offset+200)
	       case 0 
	        print #1, "bpy.data.materials['"+material+"'].node_tree.links.new(inp,outp)"
	        print #1, "bpy.data.objects['"+shape+"'].active_material = bpy.data.materials['"+material+"']"	        
	       case 1 to 9
	        print #1, "bpy.data.materials['"+material+".00"+str(mem64(sys_offset+203))+"'].node_tree.links.new(inp,outp)"
	        print #1, "bpy.data.objects['"+shape+".00"+str(mem64(sys_offset+203))+"'].active_material = bpy.data.materials['"+_
	                   material+".00"+str(mem64(sys_offset+203))+"']"		        	       
	       case 10 to 99
	        print #1, "bpy.data.materials['"+material+".0"+str(mem64(sys_offset+203))+"'].node_tree.links.new(inp,outp)"
	        print #1, "bpy.data.objects['"+shape+".0"+str(mem64(sys_offset+203))+"'].active_material = bpy.data.materials['"+_
	                   material+".0"+str(mem64(sys_offset+203))+"']"	        	       
	       case else 
	        print #1, "bpy.data.materials['"+material+str(mem64(sys_offset+203))+"'].node_tree.links.new(inp,outp)"
	        print #1, "bpy.data.objects['"+shape+material+str(mem64(sys_offset+203))+"'].active_material = bpy.data.materials['"+_
	                  material+str(mem64(sys_offset+203))+"']"		            	       
	      end select
	   case 19 ' Select all
	    print #1, "bpy.ops.object.select_all(action='TOGGLE')"
       case 20 ' Create now lamp
			select case mem64(sys_offset+200)
				case 0
				 print #1, "bpy.data.lamps.new('"+shape+"')"
				case 1 to 9
				 print #1, "bpy.data.lamps.new('"+shape+".00"+str(mem64(sys_offset+203))+"')"
				case 10 to 99
				 print #1, "bpy.data.lamps.new('"+shape+".0"+str(mem64(sys_offset+203))+"')"
				case else
				 print #1, "bpy.data.lamps.new('"+shape+str(mem64(sys_offset+203))+"')"        
			end select
	  case 21 'Turn lamp nodes off
			select case mem64(sys_offset+200)
			 case 0
			  print #1, "bpy.data.lamps['"+shape+"'].use_nodes = False"
             case 1 to 9
              print #1, "bpy.data.lamps['"+shape+".00"+str(mem64(sys_offset+203))+"'].use_nodes = False"
             case 10 to 99
              print #1, "bpy.data.lamps['"+shape+".0"+str(mem64(sys_offset+203))+"'].use_nodes = False"  
             case else 
              print #1, "bpy.data.lamps['"+shape+str(mem64(sys_offset+203))+"'].use_nodes = False"                             
			end select 
      case 22 'Turn lamp nodes on
	  		select case mem64(sys_offset+200)
	  		 case 0
			  print #1, "bpy.data.lamps['"+shape+"'].use_nodes = True"
             case 1 to 9
              print #1, "bpy.data.lamps['"+shape+".00"+str(mem64(sys_offset+203))+"'].use_nodes = True"
             case 10 to 99
              print #1, "bpy.data.lamps['"+shape+".0"+str(mem64(sys_offset+203))+"'].use_nodes = True"  
             case else 
              print #1, "bpy.data.lamps['"+shape+str(mem64(sys_offset+203))+"'].use_nodes = True"  
           end select    			
      case 23 'Change lamp type
           print #1, "bpy.data.lamps['"+shape+"'].type = "+chr(34)+lamp+chr(34) 
      case 24 'Change lamp strength
           print #1, "bpy.data.lamps['"+shape+"'].node_tree.nodes['"+_
                     "Emission'].inputs['Strength'].default_value = "+str(mem64(sys_offset+203)) 
      case 25 'Change lamp color
	       print #1, "bpy.context.object.data.color = ("+_
	                 str(mem64(sys_offset+203))+"."+str(mem64(sys_offset+206))+_
	                 ","+str(mem64(sys_offset+204))+"."+str(mem64(sys_offset+207))+","+_
                     str(mem64(sys_offset+205))+"."+str(mem64(sys_offset+208))+")"
      case 26 'Change lamp type
             select case mem64(sys_offset+200)
					case 0:lamp = "POINT"
					case 1:lamp = "SUN"
					case 2:lamp = "SPOT"
      ...
      case 27
			 select case mem64(sys_offset+204)
			   case 0
					print #1, "bpy.data.materials['"+material;
			   case 1 to 9
					print #1, "bpy.data.materials['"+material+".00"+str(mem64(sys_offset+204));
			   case 10 to 99
					print #1, "bpy.data.materials['"+material+".0"+str(mem64(sys_offset+204));
			   case else
					print #1, "bpy.data.materials['"+material+str(mem64(sys_offset+204));
			 end select
	   case 28' modifier types
			 select case mem64(sys_offset+200)
					case  0: modifier="DATA_TRANSFER"
					case  1: modifier="MESH_CACHE"
					case  2: modifier="MESH_SEQUENCE_CACHE"
					case  3: modifier="NORMAL_EDIT"
					case  4: modifier="UV_PROJECT"
					case  5: modifier="UV_WARP"
					case  6: modifier="VERTEX_WEIGHT_EDIT"
					case  7: modifier="VERTEX_WEIGHT_MIX"
					case  8: modifier="VERTEX_WEIGHT_PROXIMITY"
					case  9: modifier="ARRAY"
					case 10: modifier="BEVEL"
					case 11: modifier="BOOLEAN"
					case 12: modifier="BUILD"
					case 13: modifier="DECIMATE"
					case 14: modifier="EDGE_SPLIT"
					case 15: modifier="MASK"
					case 16: modifier="MIRROR"
					case 17: modifier="MULTIRES"
					case 18: modifier="REMESH"
					case 19: modifier="SCREW"
					case 20: modifier="SKIN"
					case 21: modifier="SOLIDIFY"
					case 22: modifier="SUBSURF"
					case 23: modifier="TRIANGULATE"
					case 24: modifier="WIREFRAME"
					case 25: modifier="ARMATURE"
					case 26: modifier="CAST"
					case 27: modifier="CORRECTIVE_SMOOTH"
					case 28: modifier="CURVE"
					case 29: modifier="DISPLACE"
					case 30: modifier="HOOK"
					case 31: modifier="LAPLACIANSMOOTH"
					case 32: modifier="LAPLACIANDEFORM"
					case 33: modifier="LATTICE"
					case 34: modifier="MESH_DEFORM"
					case 35: modifier="SHRINKWRAP"
					case 36: modifier="WARP"
					case 38: modifier="WAVE"
					case 39: modifier="CLOTH"
					case 40: modifier="COLLISION"
					case 41: modifier="DYNAMIC_PAINT"
					case 42: modifier="EXPLODE"
					case 43: modifier="FLUID_SIMULATION"
					case 44: modifier="OCEAN"
					case 45: modifier="PARTICLE_INSTANCE"
					case 46: modifier="PARTICLE_SYSTEM"
					case 47: modifier="SMOKE"
					case 48: modifier="SOFT_BODY"
			  end select
	    case 29' modifer types
			  select case mem64(sys_offset+200)
					 case  0: modtype="DataTransfer"
					 case  1: modtype="Mesh Cache"
					 case  2: modtype="Mesh Sequence Cache"
					 case  3: modtype="Set Split Normals"
					 case  4: modtype="UVProject"
					 case  5: modtype="UVWarp"
					 case  6: modtype="VertexWeightEdit"
					 case  7: modtype="VertexWeightMix"
					 case  8: modtype="VertexWeightProximity"
					 case  9: modtype="Array"
					 case 10: modtype="Bevel"
					 case 11: modtype="Boolean"
					 case 12: modtype="Build"
					 case 13: modtype="Decimate"
					 case 14: modtype="EdgeSplit"
					 case 15: modtype="Mask"
					 case 16: modtype="Mirror"
					 case 17: modtype="Multires"
					 case 18: modtype="Remesh"
					 case 19: modtype="Screw"
					 case 20: modtype="Skin"
					 case 21: modtype="Solidify"
					 case 22: modtype="Subsurf"
					 case 23: modtype="Triangulate"
					 case 24: modtype="Wireframe"
					 case 25: modtype="Armature"
					 case 26: modtype="Cast"
					 case 27: modtype="CorrectiveSmooth"
					 case 28: modtype="Curve"
					 case 29: modtype="Displace"
					 case 30: modtype="Hook"
					 case 31: modtype="Laplacian Smooth"
					 case 32: modtype="LaplacianDeform"
					 case 33: modtype="Lattice"
					 case 34: modtype="MeshDeform"
					 case 35: modtype="Shrinkwrap"
					 case 36: modtype="SimpleDeform"
					 case 37: modtype="Smooth"
					 case 38: modtype="Surface Deform"
					 case 39: modtype="Warp"
					 case 40: modtype="Wave"
					 case 41: modtype="Cloth"
					 case 42: modtype="Dynamic Paint"
					 case 43: modtype="Softbody"
					 case 44: modtype="Fluidsim"
					 case 45: modtype="Smoke"
			  end select	    		  			  
	    case 30
	          select case mem64(sys_offset+200)
					 case  0: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].ray_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case  1: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].frame_start = "+str(mem64(203))+"."+str(mem64(206))
					 case  2: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].frame_scale = "+str(mem64(203))+"."+str(mem64(206))
					 case  3: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].frame_duration = "+str(mem64(203))+"."+str(mem64(206))
					 case  4: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case  5: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case  6: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset[2] = "+str(mem64(203))+"."+str(mem64(206))
					 case  7: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].projector_count = "+str(mem64(203))+"."+str(mem64(206))
					 case  8: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].aspect_x = "+str(mem64(203))+"."+str(mem64(206))
					 case  9: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].aspect_y = "+str(mem64(203))+"."+str(mem64(206))
					 case 10: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].center[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 11: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].center[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 12: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].default_weight = "+str(mem64(203))+"."+str(mem64(206))
					 case 13: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mask_constant = "+str(mem64(203))+"."+str(mem64(206))
					 case 14: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'LINEAR'"
					 case 15: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'CURVE'"
					 case 16: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'SHARP'"
					 case 17: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'SMOOTH'"
					 case 18: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'ROOT'"
					 case 19: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'ICON_SPHERECURVE'"
					 case 20: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'RANDOM'"
					 case 21: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'STEP'"
					 case 22: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'NONE'"
					 case 23: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'SPHERE'"
					 case 24: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'INVERSE_SQUARE'"
					 case 25: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_type = 'CONSTANT'"
					 case 26: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 27: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff = "+str(mem64(203))+"."+str(mem64(206))
					 case 28: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].strength = "+str(mem64(203))+"."+str(mem64(206))
					 case 29: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 30: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].default_weight_a = "+str(mem64(203))+"."+str(mem64(206))
					 case 31: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].default_weight_b = "+str(mem64(203))+"."+str(mem64(206))
					 case 32: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mask_constant = "+str(mem64(203))+"."+str(mem64(206))
					 case 33: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 34: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_limit = "+str(mem64(203))+"."+str(mem64(206))
					 case 35: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'SET'"
					 case 36: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'ADD'"
					 case 37: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'SUB'"
					 case 38: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'MUL'"
					 case 39: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'DIV'"
					 case 40: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'DIF'"
					 case 41: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_mode = 'AVG'"
					 case 42: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_set = 'AND'"
					 case 43: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_set = 'OR'"
					 case 44: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_set = 'B'"
					 case 45: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_set = 'ALL'"
					 case 46: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mix_set = 'A'"
					 case 47: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].proximity_mode = 'OBJECT'"
					 case 48: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].proximity_mode = 'GEOMETRY''"
					 case 49: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mask_constant = "+str(mem64(203))+"."+str(mem64(206))
					 case 50: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].min_dist = "+str(mem64(203))+"."+str(mem64(206))
					 case 51: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].max_dist = "+str(mem64(203))+"."+str(mem64(206))
					 case 52: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].count = "+str(mem64(203))+"."+str(mem64(206))
					 case 53: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].constant_offset_displace[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 54: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].constant_offset_displace[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 55: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].constant_offset_displace[2] = "+str(mem64(203))+"."+str(mem64(206))
					 case 56: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].relative_offset_displace[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 57: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].relative_offset_displace[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 58: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].relative_offset_displace[2] = "+str(mem64(203))+"."+str(mem64(206))
					 case 59: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].merge_threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 60: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].fit_type = 'FIXED_COUNT'"
					 case 61: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].fit_type = 'FIT_LENGTH'"
					 case 62: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].fit_type = 'FIT_CURVE'"
					 case 63: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].width = "+str(mem64(203))+"."+str(mem64(206))
					 case 64: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].segments = "+str(mem64(203))+"."+str(mem64(206))
					 case 65: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].profile = "+str(mem64(203))+"."+str(mem64(206))
					 case 66: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].material = "+str(mem64(203))+"."+str(mem64(206))
					 case 67: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].double_threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 68: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].ratio = "+str(mem64(203))+"."+str(mem64(206))
					 case 69: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].vertex_group_factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 70: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].split_angle = "+str(mem64(203))+"."+str(mem64(206))
					 case 71: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].merge_threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 72: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 73: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].sculpt_levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 74: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].render_levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 75: print #1, "ops.object.multires_subdivide(modifier="+chr(34)+modtype+chr(34)+")"
					 case 76: print #1, "ops.object.multires_higher_levels_delete(modifier="+chr(34)+modtype+chr(34)+")"
					 case 77: print #1, "ops.object.multires_base_apply(modifier="+chr(34)+modtype+chr(34)+")"
					 case 78: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].merge_threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 79: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].octree_depth = "+str(mem64(203))+"."+str(mem64(206))
					 case 80: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].scale_x = "+str(mem64(203))+"."+str(mem64(206))
					 case 81: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].scale_y = "+str(mem64(203))+"."+str(mem64(206))
					 case 82: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].scale = "+str(mem64(203))+"."+str(mem64(206))
					 case 83: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].sharpness = "+str(mem64(203))+"."+str(mem64(206))
					 case 84: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 85: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mode = 'BLOCKS'"
					 case 86: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mode = 'SMOOTH'"
					 case 87: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mode = 'SHARP'"
					 case 88: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mode = 'VERTEX_GROUP'"
					 case 89: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mode = 'ARMATURE'"
					 case 90: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].octree_depth = "+str(mem64(203))+"."+str(mem64(206))
					 case 91: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].sharpness = "+str(mem64(203))+"."+str(mem64(206))
					 case 92: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 93: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].angle = "+str(mem64(203))+"."+str(mem64(206))
					 case 94: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].steps = "+str(mem64(203))+"."+str(mem64(206))
					 case 95: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].render_steps = "+str(mem64(203))+"."+str(mem64(206))
					 case 96: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].iterations = "+str(mem64(203))+"."+str(mem64(206))
					 case 97: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].screw_offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 98: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].merge_threshold = "+str(mem64(203))+"."+str(mem64(206))
					 case 99: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].branch_smoothing = "+str(mem64(203))+"."+str(mem64(206))
					 case 100: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].thickness = "+str(mem64(203))+"."+str(mem64(206))
					 case 101: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].thickness_clamp = "+str(mem64(203))+"."+str(mem64(206))
					 case 102: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 103: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].thickness_vertex_group = "+str(mem64(203))+"."+str(mem64(206))
					 case 104: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].edge_crease_inner = "+str(mem64(203))+"."+str(mem64(206))
					 case 105: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].edge_crease_outer = "+str(mem64(203))+"."+str(mem64(206))
					 case 106: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].edge_crease_rim = "+str(mem64(203))+"."+str(mem64(206))
					 case 107: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].material_offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 106: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].material_offset_rim = "+str(mem64(203))+"."+str(mem64(206))
					 case 109: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 110: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].render_levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 111: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].subdivision_type = 'SIMPLE'"
					 case 112: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].subdivision_type = 'CATMULL_CLARK'"
					 case 113: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].show_only_control_edges = True"
					 case 114: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].show_only_control_edges = False"
					 case 115: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].use_subsurf_uv = False"
					 case 116: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].use_subsurf_uv = True"
					 case 117: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].quad_method = 'BEAUTY'"
					 case 118: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].quad_method = 'FIXED'"
					 case 119: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].quad_method = 'FIXED_ALTERNATE'"
					 case 120: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].quad_method = 'SHORTEST_DIAGONAL'"
					 case 121: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].ngon_method = 'BEAUTY'"
					 case 122: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].ngon_method = 'CLIP'"
					 case 123: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].thickness = "+str(mem64(203))+"."+str(mem64(206))
					 case 124: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 125: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].vertex_group = "+chr(34)
					 case 126: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].crease_weight = "+str(mem64(203))+"."+str(mem64(206))
					 case 127: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].material_offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 128: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].cast_type = 'SPHERE'"
					 case 129: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].cast_type = 'CYLINDER'"
					 case 130: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].cast_type = 'CUBOID'"
					 case 131: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 132: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].size = "+str(mem64(203))+"."+str(mem64(206))
					 case 133: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 134: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].smooth_type = 'SIMPLE'"
					 case 135: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].smooth_type = 'LENGTH_WEIGHTED'"
					 case 136: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].rest_source = 'ORCO'"
					 case 137: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].rest_source = 'BIND'"
					 case 138: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].mid_level = "+str(mem64(203))+"."+str(mem64(206))
					 case 139: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].strength = "+str(mem64(203))+"."+str(mem64(206))
					 case 140: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].iterations = "+str(mem64(203))+"."+str(mem64(206))
					 case 141: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].lambda_factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 142: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].lambda_border = "+str(mem64(203))+"."+str(mem64(206))
					 case 143: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].iterations = "+str(mem64(203))+"."+str(mem64(206))
					 case 144: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].strength = "+str(mem64(203))+"."+str(mem64(206))
					 case 145: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].precision = "+str(mem64(203))+"."+str(mem64(206))
					 case 146: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 147: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].wrap_method = 'NEAREST_SURFACEPOINT'"
					 case 148: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].wrap_method = 'PROJECT'"
					 case 149: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].project_limit = "+str(mem64(203))+"."+str(mem64(206))
					 case 150: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].subsurf_levels = "+str(mem64(203))+"."+str(mem64(206))
					 case 151: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].wrap_method = 'NEAREST_VERTEX'"
					 case 152: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].angle = "+str(mem64(203))+"."+str(mem64(206))
					 case 153: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].limits[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 154: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].limits[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 155: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].deform_method = 'BEND'"
					 case 156: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].deform_method = 'TAPER'"
					 case 157: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].deform_method = 'STRETCH'"
					 case 158: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].deform_method = 'TWIST'"
					 case 159: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 160: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].iterations = "+str(mem64(203))+"."+str(mem64(206))
					 case 161: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].texture_coords = 'LOCAL'"
					 case 162: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].texture_coords = 'GLOBAL'"
					 case 163: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].texture_coords = 'OBJECT'"
					 case 164: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].texture_coords = 'UV'"
					 case 165: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].time_offset = "+str(mem64(203))+"."+str(mem64(206))
					 case 166: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].lifetime = "+str(mem64(203))+"."+str(mem64(206))
					 case 167: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].damping_time = "+str(mem64(203))+"."+str(mem64(206))
					 case 168: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].start_position_x = "+str(mem64(203))+"."+str(mem64(206))
					 case 169: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].start_position_y = "+str(mem64(203))+"."+str(mem64(206))
					 case 170: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].falloff_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 171: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].speed = "+str(mem64(203))+"."+str(mem64(206))
					 case 172: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].height = "+str(mem64(203))+"."+str(mem64(206))
					 case 173: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].width = "+str(mem64(203))+"."+str(mem64(206))
					 case 174: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].narrowness = "+str(mem64(203))+"."+str(mem64(206))
					 case 175: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.quality = "+str(mem64(203))+"."+str(mem64(206))
					 case 176: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.time_scale = "+str(mem64(203))+"."+str(mem64(206))
					 case 177: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.mass = "+str(mem64(203))+"."+str(mem64(206))
					 case 178: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.spring_damping = "+str(mem64(203))+"."+str(mem64(206))
					 case 169: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.air_damping = "+str(mem64(203))+"."+str(mem64(206))
					 case 180: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.vel_damping = "+str(mem64(203))+"."+str(mem64(206))
					 case 181: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.bending_stiffness = "+str(mem64(203))+"."+str(mem64(206))
					 case 182: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.structural_stiffness = "+str(mem64(203))+"."+str(mem64(206))
					 case 183: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.friction = "+str(mem64(203))+"."+str(mem64(206))
					 case 184: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.speed = "+str(mem64(203))+"."+str(mem64(206))
					 case 185: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.quality = "+str(mem64(203))+"."+str(mem64(206))
					 case 186: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.start_time = "+str(mem64(203))+"."+str(mem64(206))
					 case 187: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.end_time = "+str(mem64(203))+"."+str(mem64(206))
					 case 188: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.attraction_strength = "+str(mem64(203))+"."+str(mem64(206))
					 case 189: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.attraction_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 190: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.velocity_radius = "+str(mem64(203))+"."+str(mem64(206))
					 case 191: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.velocity_strength = "+str(mem64(203))+"."+str(mem64(206))
					 case 192: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.particle_influence = "+str(mem64(203))+"."+str(mem64(206))
					 case 193: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.alpha_influence = "+str(mem64(203))+"."+str(mem64(206))
					 case 194: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.inflow_velocity[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 195: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.inflow_velocity[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 196: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.inflow_velocity[2] = "+str(mem64(203))+"."+str(mem64(206))
					 case 197: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.partial_slip_factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 198: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.impact_factor = "+str(mem64(203))+"."+str(mem64(206))
					 case 199: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.initial_velocity[0] = "+str(mem64(203))+"."+str(mem64(206))
					 case 200: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.initial_velocity[1] = "+str(mem64(203))+"."+str(mem64(206))
					 case 201: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.initial_velocity[2] = "+str(mem64(203))+"."+str(mem64(206))
					 case 202: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.resolution = "+str(mem64(203))+"."+str(mem64(206))
					 case 203: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.preview_resolution = "+str(mem64(203))+"."+str(mem64(206))
					 case 204: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.simulation_rate = "+str(mem64(203))+"."+str(mem64(206))
					 case 205: print #1, "context.object.modifiers["+chr(34)+modtype+chr(34)+"].settings.frame_offset = "+str(mem64(203))+"."+str(mem64(206))                                                
	          end select
	    case 31
	         select case mem64(sys_offset+200)
	                 case 0         
    ...
    case sys_offset+175 ' Graphics Processing Unit - 2
     select case v
      case 0
     end select 
    case sys_offset+176 ' Render Anamation
      shell "blender -b -a -P tmp.py"
      shell "for a in *.bmp ; do dest=${a/*(0)/} ; mv $a $dest ; done"
	  shell "mv *.bmp ./vram/"
	  shell "rm tmp.py"	
    case sys_offset+178 ' Render                    
      shell "blender -b -P tmp.py"
	  shell "mv "+str(mem64(sys_offset+180))+_
	  ".bmp vram/"+str(mem64(sys_offset+180))+".bmp"
	  shell "rm tmp.py"
	  poke64(sys_offset+171,0) ' clear screen
	  bload "vram/"+str(mem64(sys_offset+180))+".bmp",image
	  put(0,0), image, alpha	       
	  'locate 1, 1: print "Press any key to continue."
	  'sleep
	  'poke64(11,0) ' clears the screen
    case sys_offset+179 ' Sets offset in video memory
      mem64(sys_offset+180)=v
    case sys_offset+181 ' Anamation player
	  poke64(sys_offset+171,0) ' clear screen
      for frame as ubyte = mem64(sys_offset+182) to mem64(sys_offset+183)
 	  bload "vram/"+str(frame)+".bmp", image
 	  sleep(10,1): put(0,0), image, pset   
      next frame
    case sys_offset+184 ' sets system_offset
      sys_offset = mem64(sys_offset+185) shl 16 + mem64(sys_offset+186) shl 08 +_
		           mem64(sys_offset+187)
    case sys_offset+188 ' resets screen  	    
	 cls : bload "background.bmp",0
     for offset = 0 to 1024: poke64(1024+offset, 32): next offset
    case sys_offset+189  'Graph Functions
     select case v
         case 0 ' Open R device
          open "tmp.r" for output as #1
          print #1, "setwd(" + chr(34) + "." + chr(34) + ")"
          print #1, "bmp(filename=" + chr(34) + _
          str(mem64(sys_offset+180))+".bmp" + chr(34) + _
          ", height = 600, width = 800," + ")"          
         case 1 ' Close R device
          print #1, "dev.off()"
          close #1
         case 2 
          print #1, "plot(faithful)"
         case 3
          print #1, "head(volcano)"
         case 4
          print #1, "levelplot(volcano)"      
     end select
    case sys_offset+190 'Graph Sub functions
    case sys_offset+191 'Graph Render
         shell "Rscript tmp.r"
    	 shell "mv "+str(mem64(sys_offset+180))+".bmp vram/"+ _
    	 str(mem64(sys_offset+180))+".bmp"
	     poke64(sys_offset+171,0) ' clear screen
	     bload "vram/"+str(mem64(sys_offset+180))+".bmp",image
	     put(0,0), image, alpha	       
  	     shell "rm tmp.r 0.bmp"
    case sys_offset+192 'Graph Libraries
     select case v 
      case 0
       print #1, "library(ggplot2)"
     end select
    case sys_offset+193 'Graph Packages 
     select case v
      case 0
       print #1, "require(lattice)"
     end select 
    case sys_offset+194 ' ASCII Table
      Draw String (mem64(sys_offset+195)*8,mem64(sys_offset+196)*8),chr(v) 
    case sys_offset+197 ' ASCII Table
      msg=chr(v): print #1, msg;: msg=""
    case sys_offset+198 ' ASCII Table
      msg=chr(v): print #1, msg: msg=""
    case sys_offset+199 ' signed numbers
      select case v
        case 0:  mem64(sys_offset+203) = 0 - mem64(sys_offset+203)
        case 1:  mem64(sys_offset+204) = 0 - mem64(sys_offset+204)
        case 2:  mem64(sys_offset+205) = 0 - mem64(sys_offset+205)
        case 3:  mem64(sys_offset+206) = 0 - mem64(sys_offset+206)
        case 4:  mem64(sys_offset+207) = 0 - mem64(sys_offset+207)
        case 5:  mem64(sys_offset+208) = 0 - mem64(sys_offset+208)
        case 6:  mem64(sys_offset+209) = 0 - mem64(sys_offset+209)
        case 7:  mem64(sys_offset+210) = 0 - mem64(sys_offset+210)
        case 8:  mem64(sys_offset+211) = 0 - mem64(sys_offset+211)
        case 9:  mem64(sys_offset+212) = 0 - mem64(sys_offset+212)
        case 10: mem64(sys_offset+213) = 0 - mem64(sys_offset+213)
        case 11: mem64(sys_offset+214) = 0 - mem64(sys_offset+214)
        case 12: mem64(sys_offset+215) = 0 - mem64(sys_offset+215)
        case 13: mem64(sys_offset+216) = 0 - mem64(sys_offset+216)
        case 14: mem64(sys_offset+217) = 0 - mem64(sys_offset+217)
        case 15: mem64(sys_offset+218) = 0 - mem64(sys_offset+218)
        case 16: mem64(sys_offset+219) = 0 - mem64(sys_offset+219)
        case 17: mem64(sys_offset+220) = 0 - mem64(sys_offset+220)
        case 18: mem64(sys_offset+221) = 0 - mem64(sys_offset+221)
        case 19: mem64(sys_offset+222) = 0 - mem64(sys_offset+222)
        case 20: mem64(sys_offset+223) = 0 - mem64(sys_offset+223)
        case 21: mem64(sys_offset+224) = 0 - mem64(sys_offset+224)
        case 22: mem64(sys_offset+225) = 0 - mem64(sys_offset+225)
        case 23: mem64(sys_offset+226) = 0 - mem64(sys_offset+226)
        case 24: mem64(sys_offset+227) = 0 - mem64(sys_offset+227)
        case 25: mem64(sys_offset+228) = 0 - mem64(sys_offset+228)        
        case 26: mem64(sys_offset+229) = mem64(sys_offset+203) * .01
        case 27: mem64(sys_offset+203) = mem64(sys_offset+203) * .001
        case 28: mem64(sys_offset+206) = mem64(sys_offset+206) * .01
        case 29: mem64(sys_offset+206) = mem64(sys_offset+206) * .001
        case 30: mem64(sys_offset+204) = mem64(sys_offset+204) * .01
        case 31: mem64(sys_offset+204) = mem64(sys_offset+204) * .001
        case 32: mem64(sys_offset+207) = mem64(sys_offset+207) * .01
        case 33: mem64(sys_offset+207) = mem64(sys_offset+207) * .001 
        case 34: mem64(sys_offset+205) = mem64(sys_offset+205) * .01
        case 35: mem64(sys_offset+205) = mem64(sys_offset+205) * .001
        case 36: mem64(sys_offset+208) = mem64(sys_offset+208) * .01
        case 37: mem64(sys_offset+208) = mem64(sys_offset+208) * .001
        case 38: mem64(sys_offset+209) = mem64(sys_offset+209) * .01
        case 39: mem64(sys_offset+209) = mem64(sys_offset+209) * .001
        case 40: mem64(sys_offset+210) = mem64(sys_offset+210) * .01
        case 41: mem64(sys_offset+210) = mem64(sys_offset+210) * .001
        case 42: mem64(sys_offset+211) = mem64(sys_offset+211) * .01
        case 43: mem64(sys_offset+211) = mem64(sys_offset+211) * .001
        case 44: mem64(sys_offset+212) = mem64(sys_offset+212) * .01
        case 45: mem64(sys_offset+212) = mem64(sys_offset+212) * .001
        case 46: mem64(sys_offset+213) = mem64(sys_offset+213) * .01
        case 47: mem64(sys_offset+213) = mem64(sys_offset+213) * .001
        case 48: mem64(sys_offset+214) = mem64(sys_offset+214) * .01
        case 49: mem64(sys_offset+214) = mem64(sys_offset+214) * .001 
        case 50: mem64(sys_offset+215) = mem64(sys_offset+215) * .01
        case 51: mem64(sys_offset+215) = mem64(sys_offset+215) * .001
        case 52: mem64(sys_offset+216) = mem64(sys_offset+216) * .01
        case 53: mem64(sys_offset+216) = mem64(sys_offset+216) * .001 
        case 54: mem64(sys_offset+217) = mem64(sys_offset+217) * .01
        case 55: mem64(sys_offset+217) = mem64(sys_offset+217) * .001
        case 56: mem64(sys_offset+218) = mem64(sys_offset+218) * .01
        case 57: mem64(sys_offset+218) = mem64(sys_offset+218) * .001
        case 58: mem64(sys_offset+219) = mem64(sys_offset+219) * .01
        case 59: mem64(sys_offset+219) = mem64(sys_offset+219) * .001
        case 60: mem64(sys_offset+220) = mem64(sys_offset+220) * .01
        case 61: mem64(sys_offset+220) = mem64(sys_offset+220) * .001
        case 62: mem64(sys_offset+221) = mem64(sys_offset+221) * .01
        case 63: mem64(sys_offset+221) = mem64(sys_offset+221) * .001
        case 64: mem64(sys_offset+222) = mem64(sys_offset+222) * .01
        case 65: mem64(sys_offset+222) = mem64(sys_offset+222) * .001
        case 66: mem64(sys_offset+223) = mem64(sys_offset+223) * .01
        case 67: mem64(sys_offset+223) = mem64(sys_offset+223) * .001
        case 68: mem64(sys_offset+224) = mem64(sys_offset+224) * .01
        case 69: mem64(sys_offset+224) = mem64(sys_offset+224) * .001
        case 70: mem64(sys_offset+225) = mem64(sys_offset+225) * .01
        case 71: mem64(sys_offset+225) = mem64(sys_offset+225) * .001
        case 72: mem64(sys_offset+226) = mem64(sys_offset+226) * .01
        case 73: mem64(sys_offset+226) = mem64(sys_offset+226) * .001
        case 74: mem64(sys_offset+227) = mem64(sys_offset+227) * .01
        case 75: mem64(sys_offset+227) = mem64(sys_offset+227) * .001
        case 76: mem64(sys_offset+228) = mem64(sys_offset+228) * .01
        case 77: mem64(sys_offset+228) = mem64(sys_offset+228) * .001
      end select 
    case mem64(sys_offset+229) to mem64(sys_offset+229) + 999
      adr-=mem64(sys_offset+229)
      ...
      for y as integer = 0 to 7
        for x as integer = 0 to 7
          if char(c) and (128 shr x) then
            pset(((xs+x)*2)-2,(ys+y)*2), mem64(sys_offset+201)
            pset(((xs+x)*2),((ys+y)*2)-2),mem64(sys_offset+201)
            pset((((xs+x)*2)-2),((ys+y)*2)-2),mem64(sys_offset+201)
            pset(((xs+x)*2)-1,(ys+y)*2), mem64(sys_offset+201)
            pset(((xs+x)*2),((ys+y)*2)-1),mem64(sys_offset+201)
            pset((((xs+x)*2)-1),((ys+y)*2)-1),mem64(sys_offset+201)           
            pset(((xs+x)*2),((ys+y)*2)), mem64(sys_offset+201)
          else
            pset(((xs+x)*2)-2,(ys+y)*2),mem64(sys_offset+202)
            pset(((xs+x)*2),((ys+y)*2)-2),mem64(sys_offset+202)
            pset((((xs+x)*2)-2),((ys+y)*2)-2),mem64(sys_offset+202)
            pset(((xs+x)*2)-1,(ys+y)*2),mem64(sys_offset+202)
            pset(((xs+x)*2),((ys+y)*2)-1),mem64(sys_offset+202)
            pset((((xs+x)*2)-1),((ys+y)*2)-1),mem64(sys_offset+202)                      
            pset(((xs+x)*2),((ys+y)*2)),mem64(sys_offset+202)
          end if
        next 
        c+=1
      next
